  ...
  return (
    <LegalLayout title="Terms of Service" lastUpdated={LAST_UPDATED}>
      <section className="space-y-4">
        <p>
          These Terms govern your use of OfferTracker at <a className="warm-link hover:underline" href="https://offertracker.simona.life">offertracker.simona.life</a>.
          By using the service, you agree to these Terms.
        </p>
      </section>

      <section className="mt-6 space-y-2">
        <h2 className="warm-title text-xl font-semibold">Description of Service</h2>
        <p>
      ...
      <section className="mt-6 space-y-2">
        <h2 className="warm-title text-xl font-semibold">Acceptable Use</h2>
        <p>
      ...
      <section className="mt-6 space-y-2">
        <h2 className="warm-title text-xl font-semibold">No Guarantees</h2>
        <p>
      ...
      <section className="mt-6 space-y-2">
        <h2 className="warm-title text-xl font-semibold">Limitation of Liability</h2>
        <p>
      ...
      <section className="mt-6 space-y-2">
        <h2 className="warm-title text-xl font-semibold">Termination</h2>
        <p>
      ...
      <section className="mt-6 space-y-2">
        <h2 className="warm-title text-xl font-semibold">Changes to Terms</h2>
        <p>
      ...
      <section className="mt-6 space-y-2">
        ...
        <p>
          Questions can be sent to <a className="warm-link hover:underline" href="mailto:hey.simonalife@gmail.com">hey.simonalife@gmail.com</a>.
        </p>
      </section>
    </LegalLayout>
  )
